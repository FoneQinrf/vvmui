 ...
 * @LastEditors: Fone丶峰
 * @LastEditTime: 2020-04-24 09:56:59
 * @Description: msg
...
<template>
  <demoTop gray text="Calendar">
    ...
    <Cell-Group v-if="false" title="调试">
      <Cell label="请选择日期">
        <Calendar :disabled-list="['2020/3/6','2020/3/8']" />
      </Cell>
    </Cell-Group>
    ...
    <Cell-Group v-if="false" title="开启箭头">
      <Cell label="请选择日期">
        <Calendar rightArrow />
      </Cell>
    </Cell-Group>
